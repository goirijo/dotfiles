...
if [ "$color_prompt" = yes ]; then
    ...
    PS1="${debian_chroot:+($debian_chroot)}$FGRN\u@\h$FYEL:$FRED\w\[\033[00m\]\$ "
    PS2="> "
else
...
###############################################
#######ANYTHING BELOW THIS I ADDED MYSELF######
###############################################
export GNUTERM=x11
...
alias zz='cd !$'
alias casmd='cd ~/programming/CASM'
...
#source wrappers
source ~/bin/wrappers.lib

#some things I don't like sharing or straight up won't work on shared systems
source $HOME/.bashrc.local

export DUMP=$HOME/owncloud/dump
